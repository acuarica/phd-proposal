...
% DONE: THESIS: Source of information for cast success: Config files, libraries, more complex analysis
% DONE: THESIS: What does the compiler need to know to assert that a cast won't fail at runtime?
% DONE: THESIS: Include type system soundness discussion for thesis
% DONE: THESIS: Find examples where \code{instanceof} is right and wrong
% DONE: THESIS: Quantify patterns, Qualitative data
% DONE: THESIS: Reflection as a way to /escape/ the type system, then talk about casting.
% DONE: THESIS: Expand comment on usages of C \code{goto}s in GitHub
...
% DONE: For the thesis (not here) What conclusions did they draw on JNI usage?
