...
\researchquestion{Do developers who use statically-typed languages require circumventing the --- \emph{static} --- type system?}

\researchquestion{Why --- \emph{and how} --- features and \api{}s in a statically-typed language are \emph{actually} being used to circumvent the \emph{static} type system?}
