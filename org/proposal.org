...
# To cover what has been already done,
...
More specifically, \S{}[[cha:patterns]] presents already existing code patterns related to the language features we plan to analyze.
