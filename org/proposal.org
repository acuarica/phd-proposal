...
#+BEGIN_EXPORT latex
\rquestion{How --- \emph{and why} --- statically-typed languages constraints circumvent the static type system?}

Can we divise patterns that helps language designers?, yes ?, how to test it?

Can new usage patterns in the wild give new insights that helps language designers, tools builders and researchers?
#+END_EXPORT
...
#+BEGIN: columnview :hlines 1 :maxlevel 2 :id local
