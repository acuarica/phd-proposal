...
At first, we try to implement our cast analysis automatically.
Therefore, we have added to \jnif{} partial support to do program slicing~
\cite{tip_survey_1995,weiser_program_1981}.
We have included it to be able to make more detail analysis.
