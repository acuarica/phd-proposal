...
% TODO: Add discussion or static vs. dynamic analyses for these kinds of studies.
% TODO: Why static, why not dynamic? where static is OK, where is reasonable, feasible?
...
The first question when conducting empirical studies of programs is 
...
In \S\ref{sec:lr:largescale} we give an overview of large-scale studies
either in \java{} or in other languages that show what
kind of questions researchers ask.
We end up this chapter presenting the related work more specific to
