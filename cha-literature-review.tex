...
\cite{wintherGuardedTypePromotion2011} have implemented a flow-sensitive analysis that allows to avoid manually casting once a guarded \code{instanceof} is provided.
