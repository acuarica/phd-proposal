...
% DONE: Add discussion or static vs. dynamic analyses for these kinds of studies
...
For \javascript, having a big corpus of web-site generating valid
input data is more feasible.
...
providing compile-time type safety''.\citep{goslingJavaLanguageSpecification}
...
Finally, they argue that controlled programming experiments on subjects need to be correlated with real-world use cases, \eg{}, \github{} or \mavencentral{}.
