...
\label{sec:orgca4d190}
The rest of this proposal is organized as follows:
Chapter~\ref{org4e53664} gives a review of the literature in the \emph{state-of-the-art} of the different aspects related to our goal.
More specifically, Chapter~\ref{orgdcea899} presents already existing code patterns related to the language features we plan to analyze.
The following four chapters introduce our proposal plan for the selected features:
Chapters~\ref{org2670758}, \ref{org78e1991}, \ref{orgd722532} presents our \emph{casting}, \emph{reflection} and \emph{exception handling} study respectively.
...
\chapter{Literature Review \label{org4e53664}}
\label{sec:orgde7676b}
...
In \S\ref{org2e56c30} we present empirical studies regarding compilers writers.
How benchmarks and corpuses relate to this kind of studies is presented in \S\ref{org9c243c1}.
\S\ref{org0c73e55} gives an overview of other large-scale studies either in \java{} or in other languages.
Related to our cast study, in \S\ref{org255d33b} we show studies on how static type systems impact on programmers productivity.
Code Patterns discovery is presented in \S\ref{orge57b351}.
Finally, \S\ref{org714e5b6} gives an overview of what tools are available to extract information from a software repository, while \S\ref{orgb962d69} of how to select good candidates projects.

\section{Compilers Writers \label{org2e56c30}}
\label{sec:org49d2ed6}
...
\section{Benchmarks and Corpuses \label{org9c243c1}}
\label{sec:orgbc15760}
...
\section{Large-scale Codebase Empirical Studies \label{org0c73e55}}
\label{sec:org8e192f5}
...
\section{Controlled Experiments on Subjects \label{org255d33b}}
\label{sec:org7c13592}
...
\section{Code Patterns Discovery \label{orge57b351}}
\label{sec:org7a7a856}
...
\section{Tools for Mining Software Repositories \label{org714e5b6}}
\label{sec:orgc0d924c}
...
\section{Selecting Good Representatives \label{orgb962d69}}
\label{sec:orgb5e8243}
...
\chapter{Existing Code Patterns \label{orgdcea899}}
\label{sec:orgecb3834}
\begin{table}[htbp]
...
\label{sec:org995d9c4}
\begin{enumerate}
\item Snippet
\label{sec:orgab0c21e}
...
\label{sec:org3a39744}
\begin{enumerate}
\item Snippet
\label{sec:org8983ad3}
...
\label{sec:org159b904}
\begin{enumerate}
\item Snippet
\label{sec:org7dcefbd}
...
\end{lstlisting}
\item Discussion
\label{sec:org0ab5798}

What can we say?
\end{enumerate}

\subsection{Code Unavailable Until Deployment}
\label{sec:orgddebf1b}
\begin{enumerate}
\item Snippet
\label{sec:org51d5006}
...
\label{sec:org4386abe}
\begin{enumerate}
\item Snippet
\label{sec:orga6a1e9b}
...
\label{sec:orga12d5d9}
\begin{enumerate}
\item Snippet
\label{sec:orgb0ee139}
...
\label{sec:org34bbdc6}
\begin{enumerate}
\item Snippet
\label{sec:orgd16bf04}
...
\label{sec:org5422bf1}
\begin{enumerate}
\item Snippet
\label{sec:org4a634fb}
...
\label{sec:org25017bd}
\begin{enumerate}
\item Snippet
\label{sec:orgcbb3d90}
...
We begin this chapter presenting our already published work on the Unsafe API in \ref{orgafcb77c}.

With the Unsafe API we answer the sub-research question:


\section{The Unsafe API \label{orgafcb77c}}
\label{sec:orgb936615}
...
\section{Casts \label{org2670758}}
\label{sec:org509ae04}
...
\section{Reflection Patterns \label{org78e1991}}
\label{sec:org915b4b5}
...
\subsection{Related Work}
\label{sec:org90ab091}
\section{Exceptions \label{orgd722532}}
\label{sec:org734b5cd}
